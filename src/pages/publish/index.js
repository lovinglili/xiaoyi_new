  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        loginIn_actions.publishGood(postValue, () => {
            ...
            <Form onSubmit={this.handleSubmit}>
              <Form.Item label="商品标题" {...formItemLayout}>
                {getFieldDecorator("title", {
                  ...
                  <Input placeholder="你的好物应该有个好听的名字吧~,30 字符以内" />
                )}
              </Form.Item>
              <Form.Item label="商品描述" {...formItemLayout}>
                {getFieldDecorator("desc", {
                  ...
                  <TextArea
                    rows={6}
                    placeholder="可以详细描述一下商品的新旧程度,使用感受,入手渠道,出售原因吧~，600 字符以内"
                  />
                )}
              </Form.Item>
              <Form.Item
              ...
              <Form.Item label="发布地址" {...formItemLayout}>
                {getFieldDecorator("city", {
                  rules: [{ required: true, message: "请输入你的地址哦!" }]
